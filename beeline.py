...
async def get_balance(session, phone):
...
async def wrk(config, tel):
    ...
    try:
        bal = await get_balance(session, tel)
...
if __name__ == '__main__':
    ...
    telsp = "spisok_telephonov.txt"  #sys.argv[1]
    ths = 1  #int(sys.argv[2])
